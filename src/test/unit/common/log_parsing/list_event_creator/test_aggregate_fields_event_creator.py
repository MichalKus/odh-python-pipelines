...
class EventCreatorTestCase(unittest.TestCase):
    ...
    def test_event_creates_aggregates_values(self):
        ...
        event_creator = AggregateFieldsEventCreator(metadata, SplitterParser("|"), fields_to_aggregate=["f1", "f2"],
                                                    result_field="f3", agg_func=lambda x, y: x + y)
    ...
    def test_event__creates_aggregated_values_and_removes_intermediate_fields(self):
        ...
        event_creator = AggregateFieldsEventCreator(metadata, SplitterParser("|"), fields_to_aggregate=["f1", "f2"],
                                                    result_field="f3", remove_intermediate_fields=True)
