...
class NokiaVrmMessageParsingTestCase(BaseMultipleMessageParsingTestCase):
    ...
    def test_scheduler_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2018, 02, 26, 17, 41, 06, 356000).replace(tzinfo=timezones["Europe/Amsterdam"]),
                "unknown_field": "",
                "level": "INFO",
    ...
    def test_console_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2017, 9, 20, 15, 53, 00, 10000).replace(tzinfo=timezones["Europe/Amsterdam"]),
                "level": "ERROR",
                "ip": "",
    ...
    def test_cdvr_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2018, 01, 17, 11, 30, 30, 35000).replace(tzinfo=timezones["Europe/Amsterdam"]),
                "level": "ERROR",
    ...
    def test_epg_ds_audit(self):
        self.assert_parsing({
            ...
            {
                "@timestamp": datetime(2017, 11, 29, 19, 30, 01, 480000).replace(tzinfo=timezones["Europe/Amsterdam"]),
                "level": "ERROR",
    ...
    def test_cdvr_audit(self):
        self.assert_parsing({
            ...
            {
                "@timestamp": datetime(2017, 11, 27, 03, 30, 24, 653000).replace(tzinfo=timezones["Europe/Amsterdam"]),
                "level": "ERROR",
    ...
    def test_user_audit(self):
        self.assert_parsing({
            ...
            {
                "@timestamp": datetime(2017, 11, 27, 10, 35, 01, 718000).replace(tzinfo=timezones["Europe/Amsterdam"]),
                "level": "ERROR",
    ...
    def test_lgienh_api_audit(self):
        self.assert_parsing({
            ...
            {
                "@timestamp": datetime(2018, 01, 17, 12, 50, 54, 336000).replace(tzinfo=timezones["Europe/Amsterdam"]),
                "level": "INFO",
    ...
    def test_schange_import_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2018, 01, 17, 13, 10, 01, 427000).replace(tzinfo=timezones["Europe/Amsterdam"]),
                "level": "INFO",
    ...
    def vspp_adapter_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2018, 01, 17, 13, 01, 42, 327000).replace(tzinfo=timezones["Europe/Amsterdam"]),
                "level": "INFO",
