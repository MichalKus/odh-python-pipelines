...
class NokiaVrmMessageParsingTestCase(BaseMultipleMessageParsingTestCase):
    ...
    def test_scheduler_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2018, 02, 26, 17, 41, 06, 356000),
                "unknown_field": "",
                "level": "INFO",
    ...
    def test_console_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2017, 9, 20, 15, 53, 00, 10000),
                "level": "ERROR",
                "ip": "",
    ...
    def test_authentication_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2017, 11, 27, 11, 11, 14, 331000),
                "level": "WARN",
    ...
    def test_cdvr_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2018, 01, 17, 11, 30, 30, 35000),
                "level": "ERROR",
    ...
    def test_cdvr_audit(self):
        self.assert_parsing({
            ...
            {
                "@timestamp": datetime(2017, 11, 27, 03, 30, 24, 653000),
                "level": "ERROR",
    ...
    def test_user_audit(self):
        self.assert_parsing({
            ...
            {
                "@timestamp": datetime(2017, 11, 27, 10, 35, 01, 718000),
                "level": "ERROR",
    ...
    def test_lgienh_api_audit(self):
        self.assert_parsing({
            ...
            {
                "@timestamp": datetime(2018, 01, 17, 12, 50, 54, 336000),
                "level": "INFO",
    ...
    def test_schange_import_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2018, 01, 17, 13, 10, 01, 427000),
                "level": "INFO",
    ...
    def vspp_adapter_bs_audit(self):
        self.assert_parsing(
            ...
            {
                "@timestamp": datetime(2018, 01, 17, 13, 01, 42, 327000),
                "level": "INFO",
